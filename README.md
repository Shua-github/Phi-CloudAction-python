...
- [ ] Web喵!
  ...
  - [x] GUI(可视化存档信息喵，~~感觉也没用喵，先咕咕咕吧喵~~,~~在写了在写了😭~~,部分完成)
...
``WebGUI``~~完全照搬~~大部分源自[phi-html](https://github.com/Catrong)喵(目前还没有建仓库(?))
...
### 2025/02/24(v1.5.4.1b):
针对用户:
1. 添加`WebGUI`(部分实现)

针对开发者:
1. `checkSaveHistory`更改为只存修改过的部分
